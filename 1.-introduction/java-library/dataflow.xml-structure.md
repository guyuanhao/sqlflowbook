...
This page indends to describe the structure of the dataflow.xml. DataFlowAnalyzer generates _`dataflow.xml`_ if the _`/json`_ is not set. Response will be in json format if the _`/json`_ is set. Please refer to [here](../../2.-concepts/data-lineage-format-reference.md) for the json response.
...
{% content-ref url="../../2.-concepts/sqlflow-data-reference.md#table-structure" %}
[#table-structure](../../2.-concepts/sqlflow-data-reference.md#table-structure)
{% endcontent-ref %}
...
{% content-ref url="../../2.-concepts/sqlflow-data-reference.md#column-structure" %}
[#column-structure](../../2.-concepts/sqlflow-data-reference.md#column-structure)
{% endcontent-ref %}

### OraclePackage Structure

{% content-ref url="../../2.-concepts/sqlflow-data-reference.md#oraclepackage-structure" %}
[#oraclepackage-structure](../../2.-concepts/sqlflow-data-reference.md#oraclepackage-structure)
{% endcontent-ref %}
...
{% content-ref url="../../2.-concepts/sqlflow-data-reference.md#procedure-structure" %}
[#procedure-structure](../../2.-concepts/sqlflow-data-reference.md#procedure-structure)
{% endcontent-ref %}
...
{% content-ref url="../../2.-concepts/sqlflow-data-reference.md#argument-structure" %}
[#argument-structure](../../2.-concepts/sqlflow-data-reference.md#argument-structure)
{% endcontent-ref %}

### Process Structure

{% content-ref url="../../2.-concepts/sqlflow-data-reference.md#process-structure" %}
[#process-structure](../../2.-concepts/sqlflow-data-reference.md#process-structure)
{% endcontent-ref %}
...
{% content-ref url="../../2.-concepts/sqlflow-data-reference.md#target-fields-data" %}
[#target-fields-data](../../2.-concepts/sqlflow-data-reference.md#target-fields-data)
{% endcontent-ref %}

### SourceColumn Structure

{% content-ref url="../../2.-concepts/sqlflow-data-reference.md#sourcecolumn-structure" %}
[#sourcecolumn-structure](../../2.-concepts/sqlflow-data-reference.md#sourcecolumn-structure)
{% endcontent-ref %}
...
{% content-ref url="../../2.-concepts/sqlflow-data-reference.md#transform-fields-data" %}
[#transform-fields-data](../../2.-concepts/sqlflow-data-reference.md#transform-fields-data)
{% endcontent-ref %}
