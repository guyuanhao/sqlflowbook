...
This page indends to describe the structure of the dataflow.xml. DataFlowAnalyzer generates _`dataflow.xml`_ if the _`/json`_ is not set. Response will be in json format if the _`/json`_ is set. Please refer to [here](../../7.-reference/lineage-model/json-format-lineage-model.md) for the json response.
...
{% content-ref url="../../7.-reference/lineage-model/sqlflow-data-reference.md#table-structure" %}
[#table-structure](../../7.-reference/lineage-model/sqlflow-data-reference.md#table-structure)
{% endcontent-ref %}
...
{% content-ref url="../../7.-reference/lineage-model/sqlflow-data-reference.md#column-structure" %}
[#column-structure](../../7.-reference/lineage-model/sqlflow-data-reference.md#column-structure)
{% endcontent-ref %}

### OraclePackage Structure

{% content-ref url="../../7.-reference/lineage-model/sqlflow-data-reference.md#oraclepackage-structure" %}
[#oraclepackage-structure](../../7.-reference/lineage-model/sqlflow-data-reference.md#oraclepackage-structure)
{% endcontent-ref %}
...
{% content-ref url="../../7.-reference/lineage-model/sqlflow-data-reference.md#procedure-structure" %}
[#procedure-structure](../../7.-reference/lineage-model/sqlflow-data-reference.md#procedure-structure)
{% endcontent-ref %}
...
{% content-ref url="../../7.-reference/lineage-model/sqlflow-data-reference.md#argument-structure" %}
[#argument-structure](../../7.-reference/lineage-model/sqlflow-data-reference.md#argument-structure)
{% endcontent-ref %}

### Process Structure

{% content-ref url="../../7.-reference/lineage-model/sqlflow-data-reference.md#process-structure" %}
[#process-structure](../../7.-reference/lineage-model/sqlflow-data-reference.md#process-structure)
{% endcontent-ref %}
...
{% content-ref url="../../7.-reference/lineage-model/sqlflow-data-reference.md#sourcecolumn-structure" %}
[#sourcecolumn-structure](../../7.-reference/lineage-model/sqlflow-data-reference.md#sourcecolumn-structure)
{% endcontent-ref %}
