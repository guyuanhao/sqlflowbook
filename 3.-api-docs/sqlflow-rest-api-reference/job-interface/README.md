...
<figure><img src="../../../.gitbook/assets/job-types.png" alt=""><figcaption></figcaption></figure>
...
{% swagger src="../../../swagger/swagger.yaml" path="/sqlflow/job/displayUserJobSummary" method="post" %}
[swagger.yaml](../../../swagger/swagger.yaml)
{% endswagger %}
...
{% swagger src="../../../swagger/swagger.yaml" path="/sqlflow/job/exportLineageAsJson" method="post" %}
[swagger.yaml](../../../swagger/swagger.yaml)
{% endswagger %}
