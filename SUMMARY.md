...
* [Getting Started](introduction/getting-started/README.md)
  ...
  * [Different analysis modes in Gudu SQLFlow](introduction/getting-started/different-analysis-modes-in-gudu-sqlflow/README.md)
    * [Query mode](introduction/getting-started/different-analysis-modes-in-gudu-sqlflow/query-mode.md)
    * [Job mode](introduction/getting-started/different-analysis-modes-in-gudu-sqlflow/job-mode.md)
