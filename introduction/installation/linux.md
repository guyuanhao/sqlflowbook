...
If you need enable regular job on your sqlflow on-premiser, you will need to install Clickhouse on your server. Check here for Clickhouse installation:

{% content-ref url="clickhouse/" %}
