...
You can check for [SQLFlow Widget](broken-reference) once you have your SQLFlow on-premise Installed on your server and Widget will take your installed SQLFlow as the backend of the data source.
